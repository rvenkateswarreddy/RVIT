...
const WhyChooseUs = () => {
  ...
  // Simple Framer Motion variants for sliding from left/right, no pause/stop
  const boxVariants = (idx) => ({
    initial: {
      opacity: 0,
      x: idx % 2 === 0 ? -100 : 100,
    },
    animate: {
      opacity: 1,
      x: 0,
      transition: { duration: 0.20, ease: "easeOut", delay: idx * 0.11 }
    }
  });
